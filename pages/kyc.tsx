...
export default function KYCForm() {
  ...
  const addOwner = () => setOwners([...owners, { id: Date.now(), first_name: '', last_name: '', dob: '', phone: '', proof_id: null, proof_address: null }]);
  ...
  const fetchAddresses = async () => {
    ...
    try {
      ...
      setAddressOptions(res.data.addresses.map((a) => ({ label: a, value: a })));
    } catch (err) {
