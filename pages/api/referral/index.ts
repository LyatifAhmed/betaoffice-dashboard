...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const url = `${backend}/referral?external_id=${encodeURIComponent(external_id)}`;
    ...
    console.error("Referral summary proxy error:", e?.message || e);
